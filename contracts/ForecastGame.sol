...
contract ForecastGame {
    ...
    event PoolWithdrawn(address indexed _withdrawer, uint256 _amount);
    ...
    function claimPrize() external gameIsFinalized {
        ...
        uint256 prize = b.amount + (b.amount * odds[finalOption - 1]) / 100;
    ...
    function withdrawRemainingPool() external onlyCreator gameIsFinalized {
        ...
        emit PoolWithdrawn(creator, amount);
    }
